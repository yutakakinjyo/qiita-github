...
僕は一旦現在のブランチでコミットしてもらうほうが、事故が少ないのでコミットを推奨しています。

### コミットは細かく、メッセージは詳しく理由を、Pull Request は短く

Git, GitHub のパワーが効率よく引き出されるコツとして、以下の３つのポイントがあると思います。
...
メッセージにはやったことではなく、なぜそうしたかを書いてもらうようにお願いしましょう。
Pull Request も短く

なかなか今までにないフローになるので、初めての方には難しいようです。  
慣れるまでは時間がかかりますが、あなたが見本を見せ続けることで、いつしか周りも出来るようになってきます。
